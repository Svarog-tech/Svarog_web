...
const translations = {
  cs: {
    ...
    'support.faq.q5.question': 'Jak nastavím vlastní doménu?',
    'support.faq.q5.answer': 'Vlastní doménu nastavíte v sekci Domény v administračním panelu. Stačí přidat doménu a nasměrovat DNS záznamy na naše servery.',
    'support.faq.q6.question': 'Jak získám SSL certifikát?',
    'support.faq.q6.answer': 'SSL certifikát Let\'s Encrypt je automaticky vydán a obnoven pro všechny domény na našem hostingu zdarma.',
    'support.faq.q7.question': 'Jaké PHP verze podporujete?',
    'support.faq.q7.answer': 'Podporujeme PHP verze 7.4, 8.0, 8.1, 8.2 a 8.3. Verzi můžete přepínat v administračním panelu.',
    'support.faq.q8.question': 'Podporujete Node.js?',
    'support.faq.q8.answer': 'Ano, podporujeme Node.js aplikace. Můžete je nasadit přes administrační panel nebo přes SSH přístup.',
    'support.faq.q9.question': 'Jak se připojím přes FTP?',
    'support.faq.q9.answer': 'FTP přístupové údaje naleznete v detailu vaší služby v panelu. Doporučujeme používat SFTP pro bezpečnější přenos souborů.',
    'support.faq.q10.question': 'Jak vytvořím databázi?',
    'support.faq.q10.answer': 'Databázi vytvoříte v sekci Databáze v administračním panelu. Podporujeme MySQL/MariaDB a PostgreSQL.',
    'support.faq.q11.question': 'Jak vytvořím e-mailový účet?',
    'support.faq.q11.answer': 'E-mailový účet vytvoříte v sekci E-maily v administračním panelu. Zadejte požadovanou adresu a heslo.',
    'support.faq.q12.question': 'Jaká je maximální velikost přílohy?',
    'support.faq.q12.answer': 'Maximální velikost přílohy e-mailu je 25 MB. Pro větší soubory doporučujeme použít sdílení přes odkaz.',
    'support.faq.q13.question': 'Mohu přistupovat k e-mailu přes IMAP/POP3?',
    'support.faq.q13.answer': 'Ano, podporujeme IMAP i POP3 protokol. Nastavení naleznete v detailu e-mailového účtu v administračním panelu.',
    'support.faq.q14.question': 'Jak nastavím DNS záznamy?',
    'support.faq.q14.answer': 'DNS záznamy spravujete v sekci DNS v administračním panelu. Můžete přidávat A, AAAA, CNAME, MX, TXT a další záznamy.',
    'support.faq.q15.question': 'Jak přenesu doménu k vám?',
    'support.faq.q15.answer': 'Pro přenos domény potřebujete autorizační kód (EPP) od současného registrátora. Přenos zadáte v sekci Domény.',
    'support.faq.q16.question': 'Jak dlouho trvá registrace domény?',
    'support.faq.q16.answer': 'Registrace nové domény je obvykle dokončena do několika minut. Přenos existující domény může trvat 5-7 dní.',
    'support.faq.q17.question': 'Jaké platební metody přijímáte?',
    'support.faq.q17.answer': 'Přijímáme platby kartou (Visa, Mastercard), PayPal, GoPay a bankovním převodem.',
    'support.faq.q18.question': 'Mohu získat fakturu?',
    'support.faq.q18.answer': 'Ano, faktury jsou automaticky generovány po zaplacení. Naleznete je v sekci Fakturace ve formátu HTML i PDF.',
    'support.faq.q19.question': 'Co se stane po vypršení služby?',
    'support.faq.q19.answer': 'Po vypršení služby máte 7denní ochrannou lhůtu, během které můžete službu obnovit. Poté jsou data smazána.',
    'support.faq.q20.question': 'Nabízíte vrácení peněz?',
    'support.faq.q20.answer': 'Ano, nabízíme 30denní garanci vrácení peněz. Pokud nejste spokojeni, kontaktujte naši podporu.',
    'support.faq.q21.question': 'Jak je můj hosting zabezpečen?',
    'support.faq.q21.answer': 'Používáme firewall, DDoS ochranu, automatické bezpečnostní aktualizace a izolaci účtů pro maximální bezpečnost.',
    'support.faq.q22.question': 'Jak fungují zálohy?',
    'support.faq.q22.answer': 'Automatické zálohy probíhají denně a uchováváme je po dobu 7 dní. Zálohu můžete obnovit z administračního panelu.',
  ...
  en: {
    ...
    'support.faq.q5.question': 'How do I set up a custom domain?',
    'support.faq.q5.answer': 'You can set up a custom domain in the Domains section of the admin panel. Just add the domain and point DNS records to our servers.',
    'support.faq.q6.question': 'How do I get an SSL certificate?',
    'support.faq.q6.answer': 'A free Let\'s Encrypt SSL certificate is automatically issued and renewed for all domains on our hosting.',
    'support.faq.q7.question': 'Which PHP versions do you support?',
    'support.faq.q7.answer': 'We support PHP versions 7.4, 8.0, 8.1, 8.2, and 8.3. You can switch versions in the admin panel.',
    'support.faq.q8.question': 'Do you support Node.js?',
    'support.faq.q8.answer': 'Yes, we support Node.js applications. You can deploy them via the admin panel or SSH access.',
    'support.faq.q9.question': 'How do I connect via FTP?',
    'support.faq.q9.answer': 'FTP credentials can be found in your service details in the panel. We recommend using SFTP for more secure file transfers.',
    'support.faq.q10.question': 'How do I create a database?',
    'support.faq.q10.answer': 'You can create a database in the Databases section of the admin panel. We support MySQL/MariaDB and PostgreSQL.',
    'support.faq.q11.question': 'How do I create an email account?',
    'support.faq.q11.answer': 'You can create an email account in the Emails section of the admin panel. Enter the desired address and password.',
    'support.faq.q12.question': 'What is the maximum attachment size?',
    'support.faq.q12.answer': 'The maximum email attachment size is 25 MB. For larger files, we recommend using link sharing.',
    'support.faq.q13.question': 'Can I access email via IMAP/POP3?',
    'support.faq.q13.answer': 'Yes, we support both IMAP and POP3 protocols. Settings can be found in the email account details in the admin panel.',
    'support.faq.q14.question': 'How do I configure DNS records?',
    'support.faq.q14.answer': 'You can manage DNS records in the DNS section of the admin panel. You can add A, AAAA, CNAME, MX, TXT, and other records.',
    'support.faq.q15.question': 'How do I transfer a domain to you?',
    'support.faq.q15.answer': 'To transfer a domain, you need an authorization code (EPP) from your current registrar. You can initiate the transfer in the Domains section.',
    'support.faq.q16.question': 'How long does domain registration take?',
    'support.faq.q16.answer': 'New domain registration is usually completed within minutes. Transferring an existing domain may take 5-7 days.',
    'support.faq.q17.question': 'What payment methods do you accept?',
    'support.faq.q17.answer': 'We accept card payments (Visa, Mastercard), PayPal, GoPay, and bank transfers.',
    'support.faq.q18.question': 'Can I get an invoice?',
    'support.faq.q18.answer': 'Yes, invoices are automatically generated after payment. You can find them in the Billing section in both HTML and PDF format.',
    'support.faq.q19.question': 'What happens after my service expires?',
    'support.faq.q19.answer': 'After service expiration, you have a 7-day grace period to renew. After that, data is permanently deleted.',
    'support.faq.q20.question': 'Do you offer money-back guarantee?',
    'support.faq.q20.answer': 'Yes, we offer a 30-day money-back guarantee. If you are not satisfied, contact our support team.',
    'support.faq.q21.question': 'How is my hosting secured?',
    'support.faq.q21.answer': 'We use firewalls, DDoS protection, automatic security updates, and account isolation for maximum security.',
    'support.faq.q22.question': 'How do backups work?',
    'support.faq.q22.answer': 'Automatic backups run daily and are kept for 7 days. You can restore a backup from the admin panel.',
